...
邮箱: ${req.body.email}
    ...
    <a href="http://songuu.top:8080/blog" style="text-decoration: none; background: lightgreen;color: #fff; height: 2rem; line-height: 2rem; padding: 0 1rem; display: inline-block; border-radius: 0.2rem;">回到博客</a>
    </div>
    `
